...
export default function OnboardingStartScreen() {
  ...
  function handleContinue() {
    ...
    if (selected === "vehicle") {
      ...
      router.push("/add-property?onboarding=true");
    } else {
      // Health: route into add-family-member so the user's first chosen
      // intent becomes the next action, not a premature onboarding completion.
      router.push("/add-family-member?onboarding=true");
    }
  }
