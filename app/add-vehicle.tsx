...
const VEHICLE_TYPE_GROUPS: { label: string; types: { value: string; label: string; icon: string }[] }[] = [
  {
    ...
    types: [
      ...
      { value: "semi_truck", label: "Semi Truck", icon: "truck-cargo-container" },
      { value: "rv", label: "RV / Camper", icon: "rv-truck" },
      { value: "atv", label: "ATV", icon: "atv" },
      { value: "utv", label: "UTV / Side-by-Side", icon: "go-kart" },
  ...
  },
  {
    ...
    types: [
      ...
      { value: "pwc", label: "Personal Watercraft", icon: "ski-water" },
    ],
  },
  {
    label: "Small Equipment",
    types: [
      { value: "lawnmower", label: "Lawn Mower", icon: "mower" },
      { value: "chainsaw", label: "Chainsaw", icon: "hand-saw" },
      { value: "generator", label: "Generator", icon: "lightning-bolt" },
      { value: "snow_blower", label: "Snow Blower", icon: "snowflake" },
      { value: "pressure_washer", label: "Pressure Washer", icon: "water-pump" },
      { value: "wood_chipper", label: "Wood Chipper", icon: "tree" },
      { value: "stump_grinder", label: "Stump Grinder", icon: "saw-blade" },
      { value: "concrete_saw", label: "Concrete Saw", icon: "saw-blade" },
      { value: "welder", label: "Welder", icon: "flash" },
    ],
  },
  {
    ...
    types: [
      ...
      { value: "skid_steer", label: "Skid Steer", icon: "bulldozer" },
      { value: "mini_excavator", label: "Mini Excavator", icon: "excavator" },
      { value: "compact_track_loader", label: "Compact Track Loader", icon: "tank" },
      { value: "backhoe", label: "Backhoe", icon: "tractor" },
      { value: "wheel_loader", label: "Wheel Loader", icon: "tractor-variant" },
      { value: "telehandler", label: "Telehandler", icon: "forklift" },
